    ...
    <section className="hero-search">
      <div className='hero-div'>
        <div className='hero-left'>
          ...
          <p>Add to your list of <span>favourite</span> shows with a single click. Another click to mark them as <span>watch later</span>, and another to <span>remove</span>.</p>
        </div>
